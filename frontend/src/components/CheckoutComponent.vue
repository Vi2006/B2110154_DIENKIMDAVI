<template>
  <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <div class="row">
        <div class="col m8">
          <h1 class="text-center">Mua Hàng</h1>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col m8">
          <div class="card">
            <div class="card-body">
              <p v-if="cartEmpty" style="padding: 20px">Giỏ hàng trống rỗng.</p>
            ...
            <div class="card-footer" v-if="!cartEmpty">
              <div class="row">
                <div class="col offset-m6 m6">
                  <button
                    type="button"
                    class="waves-effect waves-light btn offset-m2"
  ...
  methods: {
    cashOnDelivery: function () {
      ...
      if (
        ...
        swal.fire("Lỗi", "Vui lòng điền vào tất cả các trường.", "error");
        return;
      }
      ...
      swal
        .fire({
          ...
          text: "Tôi muốn xử lý đơn hàng của mình bằng hình thức thanh toán khi giao hàng.",
          icon: "warning",
