<template>
  <div class="section no-pad-bot" id="index-banner">
    <div class="container-fluid">
      <br /><br />
      <h1 class="header center orange-text">Welcome to the Morra store</h1>
      <div class="row center">
        <h5 class="header col s12 light">
          “Nước hoa là một vật thể thân mật, là phản xạ của trái tim.”
        </h5>
      </div>
      <br /><br />
        ...
        <div class="col m1">
          <div class="card">
            <div
              ...
              "
            >
              <p style="cursor: pointer" v-on:click="onclickCategory">Tất Cả</p>
            </div>
          </div>
              ...
              <div class="card white darken-1">
                ...
                <div class="card-action">
                  ...
                  <span style="float: right; color: black"
                    >Trong kho: <span v-text="product.itemsInStock || 0"></span
                  ></span>
                </div>
              </div>
            </div>
